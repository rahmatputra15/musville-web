...
const BannerHero = () => {
    ...
    const confirmDelete = () => {
        if (bannerToDelete) {
            router.delete(`/admin/banner/hero/${bannerToDelete.id}`, {
                preserveScroll: true,
                onSuccess: () => {
                    ...
                    setNotification({
                        type: "success",
                        message: "Banner hero deleted successfully",
                    });
                },
            });
        }
    ...
    const handleEdit = (banner) => {
        ...
        setFormData({
            ...
            subsubtitle: banner.subsubtitle || "",
            image: null,
            order: banner.order,
    ...
    const handleSubmit = (e) => {
        ...
        data.append("subsubtitle", formData.subsubtitle);
        if (formData.image) {
        ...
        if (showEditModal) {
            ...
            router.post(`/admin/banner/hero/${bannerToEdit.id}`, data, {
                preserveScroll: true,
                onSuccess: () => {
                    ...
                    setNotification({
                        type: "success",
                        message: "Banner hero updated successfully",
                    });
                },
                onError: (errors) => {
            ...
            router.post("/admin/banner/hero", data, {
                preserveScroll: true,
                onSuccess: () => {
                    ...
                    setNotification({
                        type: "success",
                        message: "Banner hero created successfully",
                    });
                },
                onError: (errors) => {
                    setFormErrors(errors);
    ...
    return (
        <>
            <Head title="Banner Hero Management - Musville" />

            <DashboardLayout activePage="/admin/banner/hero">
                {/* Flash Notification */}
                    ...
                    <div className="mb-8 flex justify-between items-center">
                        <div>
                            ...
                            <p className="text-gray-400">
                                Manage hero banners for the homepage
                            </p>
                        </div>
                        <button
                                ...
                                <div className="p-6 space-y-4 max-h-[calc(90vh-140px)] overflow-y-auto scrollbar-thin">
                                    ...
                                    <div>
                                        ...
                                        <input
                                            ...
                                            onChange={(e) =>
                                                setFormData({
                                                    ...formData,
                                                    subsubtitle: e.target.value,
                                                })
                                            }
                                            className={`w-full px-4 py-2 bg-black/50 border ${
                                                formErrors.subsubtitle
                                                    ? "border-red-500"
                                                    : "border-amber-500/50"
                                            } rounded-lg text-white focus:outline-none focus:ring-2 focus:ring-amber-500`}
                                    ...
                                    <div>
                                        ...
                                        <input
                                            ...
                                            className={`w-full px-4 py-2 bg-black/50 border ${
                                                formErrors.image
                                                    ? "border-red-500"
                                                    : "border-amber-500/50"
                                            } rounded-lg text-white file:mr-4 file:py-2 file:px-4 file:rounded-lg file:border-0 file:bg-amber-500 file:text-white file:font-semibold hover:file:bg-amber-600 cursor-pointer focus:outline-none focus:ring-2 focus:ring-amber-500`}
                                        />
                                        {formErrors.image && (
                                            <p className="text-red-500 text-sm mt-1">
                                                {formErrors.image}
                                        ...
                                        <p className="text-gray-400 text-sm mt-1">
                                            Maximum file size: 2MB. Accepted
                ...
                {showDeleteModal && bannerToDelete && (
                    <div className="fixed inset-0 bg-black/70 backdrop-blur-sm z-50 flex items-center justify-center p-4">
                        <div className="bg-gray-900 rounded-lg max-w-md w-full border border-red-500/30 shadow-2xl">
                            <div className="p-6">
                                ...
                                <div className="flex gap-4">
                                    <button
                                        ...
                                        className="flex-1 px-6 py-3 bg-gray-800 hover:bg-gray-700 text-white font-semibold rounded-lg transition-colors border border-amber-500/30"
                                    >
                                        Cancel
                                    </button>
                                    <button
                                        onClick={confirmDelete}
                                        className="flex-1 px-6 py-3 bg-red-500 hover:bg-red-600 text-white font-semibold rounded-lg transition-all shadow-lg hover:shadow-red-500/50"
                                    >
                                        Delete
                                    </button>
                                </div>

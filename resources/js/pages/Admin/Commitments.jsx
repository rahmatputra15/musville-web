...
const Commitments = () => {
    const { commitments, filters, flash } = usePage().props;
    ...
    const [commitmentToEdit, setCommitmentToEdit] = useState(null);
    ...
    const confirmDelete = () => {
        if (commitmentToDelete) {
            router.delete(
                `/admin/partnership/commitment/${commitmentToDelete.id}`,
                {
                    preserveScroll: true,
                    onSuccess: () => {
    ...
    const handleSubmit = (e) => {
        ...
        if (commitmentToEdit) {
            router.put(
                `/admin/partnership/commitment/${commitmentToEdit.id}`,
                formData,
                options
            );
        } else {
            router.post("/admin/partnership/commitment", formData, options);
        }
    };
    ...
    return (
        <>
            <Head title="Commitments - Musville" />

            <DashboardLayout activePage="/admin/partnership/commitment">
                {/* Flash Notification */}
                    ...
                    <div className="mb-8 flex justify-between items-center">
                        <div>
                            ...
                            <p className="text-gray-400">
                                Manage company commitments and values
                            </p>
                        </div>
                        <button
                                ...
                                <div className="p-6 space-y-4 overflow-y-auto scrollbar-thin max-h-[calc(90vh-140px)]">
                                    ...
                                    <div>
                                        ...
                                        <input
                                            ...
                                            className="w-full px-4 py-2 bg-black/50 border border-amber-500/50 rounded-lg text-white placeholder-gray-500 focus:outline-none focus:ring-2 focus:ring-amber-500"
                                            placeholder="Enter commitment subtitle"
                                        />
                                        {formErrors.subtitle && (
                                            <p className="mt-1 text-sm text-red-500">
                                                {formErrors.subtitle}

    ...
    return (
        <>
            ...
            <UsersLayout activePage="contact">
                    ...
                    <div className="relative z-20 h-full flex items-center justify-center">
                        ...
                        >
                            <h1 className="mt-10 text-5xl md:text-6xl font-bold text-white mb-4 drop-shadow-lg">
                                {banner ? banner.title : "Kontak Kami"}
                            </h1>
                    ...
                    <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                        <div className="grid grid-cols-1 md:grid-cols-2 gap-12">
                            ...
                            >
                                ...
                                <div className="space-y-6">
                                    <motion.div
                                        ...
                                        className="flex items-start gap-4 p-4 bg-gray-900 border border-amber-500/20 rounded-lg hover:border-amber-500/50 transition"
                                    >
                                        <svg
                                            className="w-6 h-6 text-amber-500 mt-1 shrink-0"
                                            fill="none"
                                            stroke="currentColor"
                                            viewBox="0 0 24 24"
                                        >
                                    ...
                                    >
                                        <svg
                                            className="w-6 h-6 text-emerald-500 mt-1 shrink-0"
                                            fill="none"
                                            stroke="currentColor"
                                            viewBox="0 0 24 24"
                                        >
                            ...
                            >
                                ...
                                <p className="text-gray-400 mb-8">
                                    Terhubunglah dengan kami di media sosial
                                    untuk mendapatkan pembaruan dan berita
                                    terbaru
                                </p>
                                <div className="space-y-4 mb-8">
                                    <motion.a
                                        ...
                                        className="flex items-center gap-4 p-4 bg-gray-900 border border-amber-500/20 rounded-lg hover:border-amber-500/50 transition group"
                                    >
                                ...
                                <motion.div
                                    ...
                                    className="bg-linear-to-br from-amber-500/10 to-yellow-600/10 border border-amber-500/30 rounded-lg p-6"
                                >
                                    <h4 className="text-xl font-semibold text-amber-500 mb-3">
                                        Jam Kerja
                                    </h4>
                ...
                {/* CTA Section */}
                <section className="py-16 bg-linear-to-br from-amber-600 via-yellow-700 to-amber-800">
                    <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
                        ...
                        >
                            ...
                            <p className="text-amber-100 text-lg mb-8">
                                Hubungi kami hari ini untuk membahas peluang
                            ...
                            <a
                                ...
                                target="_blank"
                                rel="noopener noreferrer"
                                className="inline-flex items-center gap-2 bg-white text-amber-700 font-semibold px-8 py-4 rounded-lg hover:bg-gray-100 transition shadow-lg"
                            >
                                <svg
                                    className="w-6 h-6"
                                    fill="currentColor"

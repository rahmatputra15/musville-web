                    ...
                    <div className="relative z-20 h-full flex items-center justify-center">
                        ...
                        >
                            ...
                            <p className="text-gray-200 text-lg md:text-xl max-w-2xl mx-auto drop-shadow">
                                {banner
                                    ? banner.subtitle
                                    : "Jelajahi peluang kemitraan kami dan tumbuh bersama kami"}
                            </p>
                        </motion.div>
                    </div>
                </section>
                    ...
                    <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
                        ...
                        >
                            <p className="text-gray-400 text-lg leading-relaxed">
                                Kami berkomitmen membangun kemitraan yang saling
                                menguntungkan demi pertumbuhan berkelanjutan.
                                Baik untuk investasi properti premium maupun
                                pengembangan karier di industri properti, kami
                                menghadirkan peluang yang tepat untuk kesuksesan
                                Anda.
                            </p>
                        </motion.div>
                    </div>
